...
import { BarChart3, Bell, Bot, Building2, CalendarCheck2, CheckSquare2, ChevronDown, CircleDollarSign, ClipboardCheck, FileBarChart, FileText, FolderOpen, HandCoins, LayoutDashboard, Menu, ReceiptText, Search, Settings, Upload, WalletCards } from 'lucide-react';
...
const primaryNav = [
  ...
  { key: 'income', label: 'Income', icon: CircleDollarSign, href: '#' },
  { key: 'expenses', label: 'Expenses', icon: WalletCards, href: '#' },
  ...
  { key: 'requests', label: 'Payment Requests', icon: FileText, href: '#' },
  { key: 'budgets', label: 'Budgets', icon: BarChart3, href: '#' },
];
const workflowNav = [
  { key: 'tasks', label: 'My Tasks', icon: CheckSquare2, href: '/tasks' },
  { key: 'approvals', label: 'Approvals', icon: ClipboardCheck, href: '#', count: 8 },
  ...
  { key: 'closing', label: 'Monthly Closing', icon: CalendarCheck2, href: '#' },
  { key: 'assistant', label: 'AI Assistant', icon: Bot, href: '#' },
];
